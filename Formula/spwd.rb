class Spwd < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Aeron/spwd/releases/download/1.0.0/spwd-aarch64-apple-darwin.tar.gz"
      sha256 "84ff5172af48adfe4f7729b34d01389e63c95081ff6ee3b3d2111109804ae0e6"
    end

    on_intel do
      url "https://github.com/Aeron/spwd/releases/download/1.0.0/spwd-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/Aeron/spwd/releases/download/1.0.0/spwd-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "e1b1b23c9fa1fa3127f5ad3a338f513c7eceb56a437211988a0971a17e1b88bc"
    end

    on_intel do
      url "https://github.com/Aeron/spwd/releases/download/1.0.0/spwd-x86_64-unknown-linux-gnu.tar.gz"
